...
?>
                                ...
                                <table width="100%" border="0" cellspacing="1" cellpadding="1" class="ajaxEditForm">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <select name="asession" id="asession" class="textbox fWidth">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <select name="class" id="class" class="textbox fWidth"
                                                    onchange="wt_ajax_chain('html*subject_id*subject,subjectId,subjectName*classId=class','','','');" >
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <select name="subject_id" id="subject_id" class="textbox fWidth"
                                                    onchange="wt_ajax_chain('html*chapter*question_chapter,question_chapter_id,title*subject_id=subject_id','','','');">
                                        ...
                                        <td>
                                            ...
                                            <select name="chapter" id="chapter" class="textbox fWidth"
                                                    onchange="wt_ajax_chain('html*topic*question_topic,question_topic_id,title*question_chapter_id=chapter','','','');"><option value="">Select chapter</option>
                                            </select>
                                        </td>
                                    </tr><tr >
                                        <td>Topic </td>
    ...
    <script>
        ...
        function WT_eclassFillData(data)  // fill data form by JSON
        {
            ...
            global_subjectId=objJSON.subject_id;
            wt_ajax_chain('html*subject_id*subject,subjectId,subjectName*classId=class','','','setSubjectId()');

        }

        var global_subjectId='';
        function setSubjectId(){os.setVal('subject_id',global_subjectId); }
