...
<body>
   ...
   <? function footer_text($page=1){ 
    global $data,$os;
    ?>
    <div style=" border-bottom:1px solid #000000; margin:5px 0px;">
...
<div style="background-color:#FFFFFF; font-size:12px; text-align:center;">
  ...
  <table class="uk-table uk-table-small listTable">
    ...
    <tr>
        ...
        <td><?php echo isset($number_of_lesson_plan['grand_total'])?$number_of_lesson_plan['grand_total']:'' ?></td>
    </tr>
</table>
...
<table class="uk-table uk-table-small listTable">
    ...
    <tr>
        <td colspan="14"  style="text-align: right;">Grand total</td>
        <td><?php echo isset($number_of_class_test['grand_total'])?$number_of_class_test['grand_total']:'' ?></td>
    </tr>
</table>
...
<table class="uk-table uk-table-small listTable">
    ...
    <tr>
        <td colspan="14"  style="text-align: right;">Grand total</td>
        <td><?php echo isset($no_of_classes_observed['grand_total'])?$no_of_classes_observed['grand_total']:'' ?></td>
    </tr>
</table>
...
<table class="uk-table uk-table-small listTable tickmark">
    ...
    <tr>
        <td>V</td>
        <td><?php echo isset($manipulatives['v_rhymes'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['v_chart'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['v_model'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['v_extra_study_matrial'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['v_debate_and_extempore'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['v_story_telling'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['v_theater_as_pedagogy'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['v_sc_exp'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['v_sc_chart'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['v_work_sheet'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['v_puzzle_and_tan_grams'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['v_mental_math'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['v_map_globe'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['v_field_work'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['v_smart_class'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['v_group_work'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['v_project'])?"&checkmark;":""?></td>
    </tr>
    <tr>
        <td>VI</td>
        <td><?php echo isset($manipulatives['vi_rhymes'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vi_chart'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vi_model'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vi_extra_study_matrial'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vi_debate_and_extempore'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vi_story_telling'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vi_theater_as_pedagogy'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vi_sc_exp'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vi_sc_chart'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vi_work_sheet'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vi_puzzle_and_tan_grams'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vi_mental_math'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vi_map_globe'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vi_field_work'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vi_smart_class'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vi_group_work'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vi_project'])?"&checkmark;":""?></td>
    </tr>
    <tr>
        <td>VII</td>
        <td><?php echo isset($manipulatives['vii_rhymes'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vii_chart'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vii_model'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vii_extra_study_matrial'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vii_debate_and_extempore'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vii_story_telling'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vii_theater_as_pedagogy'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vii_sc_exp'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vii_sc_chart'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vii_work_sheet'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vii_puzzle_and_tan_grams'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vii_mental_math'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vii_map_globe'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vii_field_work'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vii_smart_class'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vii_group_work'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['vii_project'])?"&checkmark;":""?></td>
    </tr>
    <tr>
        <td>VIII</td>
        <td><?php echo isset($manipulatives['viii_rhymes'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['viii_chart'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['viii_model'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['viii_extra_study_matrial'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['viii_debate_and_extempore'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['viii_story_telling'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['viii_theater_as_pedagogy'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['viii_sc_exp'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['viii_sc_chart'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['viii_work_sheet'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['viii_puzzle_and_tan_grams'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['viii_mental_math'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['viii_map_globe'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['viii_field_work'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['viii_smart_class'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['viii_group_work'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['viii_project'])?"&checkmark;":""?></td>
    </tr>

    <tr>
        <td>IX</td>
        <td><?php echo isset($manipulatives['ix_rhymes'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['ix_chart'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['ix_model'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['ix_extra_study_matrial'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['ix_debate_and_extempore'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['ix_story_telling'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['ix_theater_as_pedagogy'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['ix_sc_exp'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['ix_sc_chart'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['ix_work_sheet'])?"&checkmark;":""?></td>
        <td> <?php echo isset($manipulatives['ix_puzzle_and_tan_grams'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['ix_mental_math'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['ix_map_globe'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['ix_field_work'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['ix_smart_class'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['ix_group_work'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['ix_project'])?"&checkmark;":""?></td>
    </tr>
    <tr>
        <td>X</td>
        <td><?php echo isset($manipulatives['x_rhymes'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['x_chart'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['x_model'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['x_extra_study_matrial'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['x_debate_and_extempore'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['x_story_telling'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['x_theater_as_pedagogy'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['x_sc_exp'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['x_sc_chart'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['x_work_sheet'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['x_puzzle_and_tan_grams'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['x_mental_math'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['x_map_globe'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['x_field_work'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['x_smart_class'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['x_group_work'])?"&checkmark;":""?></td>
        <td><?php echo isset($manipulatives['x_project'])?"&checkmark;":""?></td>
    </tr>
</table>
<!-- aa -->
...
<tr >
    <td>Daily basis ABACUS Class (V & VI):   
    </td>
