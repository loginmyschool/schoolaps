...
<table class="container">
  ...
  <tr>
	...
	<? if($os->access('wtDelete')){ ?><input type="button" value="Delete" onclick="WT_electric_billDeleteRowById('');" style="display:none;" /><? } ?>
	&nbsp;&nbsp;
...
<tr >
	  									<td colspan="2">Branch
										<br />
										<select name="branch_code" id="branch_code" class="textbox fWidth select2" style="width:250px;" ><option value=""> </option>
  ...
  <input type="text" id="searchKey" />   &nbsp;
	...
	<span>
	Branch:
	<select name="branch_code" id="branch_code_s" class="textbox fWidth select2" style="width:300px;" ><option value=""> </option>
	<? $os->onlyOption($branch_code_arr,'')?>
							</select>
...
// $('#branch_code').val(objJSON.branch_code);
