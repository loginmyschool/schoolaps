...
$rbpbillId=$rowId;
 //$rbpbillId
$table=$os->rowByField('','rbpbill','rbpbillId',$rbpbillId);
$details=$os->rowsByField('','rbpbilldetails','rbpbillId',$rbpbillId);
...
/*.watermark{ background:#FFFFFF url(<? echo $company['watermark'] ?>) no-repeat center center; background-size: 35% auto;}*/
...
<table width="780"  border="0" cellspacing="0" cellpadding="0" class="billTbl alignCenter watermark" style="margin-top:15px;">
	  ...
	  <?php }}?>
	   ...
	   <tr>
		...
		<!-- Vat @ <? echo $orderData['taxRate'].' %'; ?> <br />-->
		  ...
		  <font style="font-size:14px;"> &#x2751;  </font>VAT &nbsp;<font style="font-size:14px;"> &#x2751;</font> CST     <?php if($orderData['taxRate']>0){echo $orderData['taxRate'].' %';}?><br /> 
...
<!--		Round Off.<br />-->
		...
		<br /><?php echo $orderData['deliveryCharge'];?>

  <br /><?php echo $orderData['installCharge'];?>
	...
	<tr>
		...
		<td colspan="10" style="text-align:left; font-size:15px;"> Total in Words :<b> <?php
			...
			<td valign="middle">&nbsp;<img src="<?php echo $site['url-wtos'];?>images/s.gif" alt="*" border="0" /> VAT NO. - <? echo $company['vatNo'] ?></td>

			 

			<td valign="middle">&nbsp;<img src="<?php echo $site['url-wtos'];?>images/s.gif" alt="*" border="0" /> CST NO. - <? echo $company['cstNo'] ?></td>
			...
			<td valign="middle">&nbsp;<img src="<?php echo $site['url-wtos'];?>images/s.gif" alt="*" border="0" /> Service TAX NO. - <? echo $company['serviceTaxNo']; ?></td>

			 

			<td valign="middle">&nbsp;<img src="<?php echo $site['url-wtos'];?>images/s.gif" alt="*" border="0" /> w.e.f. - <? echo $company['wef'] ?></td>

			  </tr>

			  <tr>

			<td valign="middle">&nbsp;<img src="<?php echo $site['url-wtos'];?>images/s.gif" alt="*" border="0" /> Buyer's VAT No. - <?php echo $customerVat;?></td>

			 

			<td valign="middle">&nbsp;<img src="<?php echo $site['url-wtos'];?>images/s.gif" alt="*" border="0" /> Buyer's CST No. - <?php echo $customerCst;?></td>
