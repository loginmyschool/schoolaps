        ...
        <div id="question_list_form">
...

            {
                ...
                <div class="uk-margin-small uk-padding-small" style="background-color:#F2F2FF;">
                    <h3><? echo $serial ?>  <? echo  $question_row['questionText']; ?> <span style="color:#FF0000; font-weight:bold; cursor:pointer;" onclick="removeRowAjaxFunction('question','questionId','<? echo  $question_row['questionId']; ?>','','','list_exam_subject(\'\')');">X</span></h3>
