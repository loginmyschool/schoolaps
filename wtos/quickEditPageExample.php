...
$options['relation']=array('dated'=>'','amount'=>'','mode'=>'paymentMode','details'=>''); // select * from table where   --fld-id-fld-name
$options['class']=array('dated'=>'dtpk payDate','amount'=>'paymentText','mode'=>'paymentdown','details'=>'paymentText');  ## add jquery date class
$options['extra']=array('paidDate'=>'','paidAmount'=>'','method'=>'','details'=>'onclick="testme()"');
