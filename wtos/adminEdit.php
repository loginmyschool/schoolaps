...
{
	$hideShowPassTr='style="display:none"';
}
?><?
...
<tr >
									...
									<tr >
										...
										<img id="imagePreview" src="<?php echo $site['url'].$os->getVal('image') ?>" height="100" <?if(!$os->getVal('image')){?>style="display:none;" <?}?>  /> 
