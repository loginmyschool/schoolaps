  ...
  <td ><b>Status</b></td>  
   <td ><b>Marque</b></td>  
    <td ><b>Status New</b></td>  
					...
					<? if($os->access('wtEdit')){ ?> 	<a href="javascript:void(0)" onclick="os.deleteRecord('<?php echo  $rowId ?>') ">Delete</a><? } ?>	 
...
<td> 
  ...
  <td> <? $os->editSelect($os->marquee,$record['marquee'],'noticeboard','marquee','noticeboardId',$record['noticeboardId'], $inputNameID='editSelect',$extraParams='class="editSelect" ') ?>  </td>
  <td> <? $os->editSelect($os->statusNew,$record['statusNew'],'noticeboard','statusNew','noticeboardId',$record['noticeboardId'], $inputNameID='editSelect',$extraParams='class="editSelect" ') ?>  </td>
