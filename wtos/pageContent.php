			    ...
			    &nbsp; &nbsp; Current Home Page   <select name="homepage" id="pagecontentIdHome" onchange="setHomePage();" >
				 ...
				 <table  border="0" cellspacing="1" cellpadding="2" class="listTable" >
							...
							<tr  class="trListing" style="<? echo $homeColor ?>" >
								...
								<td> 
								<? $os->editText($record['priority'],'pagecontent','priority','pagecontentId',$record['pagecontentId'], $inputNameID='editText',$extraParams='class="editText" ');?>  </td>
								...
								<td> <? $os->editSelect(array('0'=>'','1'=>'Only Login', '2'=>'Only Without Login'),$record['login_access'],'pagecontent','login_access','pagecontentId',$record['pagecontentId'], $inputNameID='editSelects',$extraParams='class="editSelect" ',array()) ?>  </td>
								
								
								
								
								  <td class="actionLink" style="width:120px">                   
