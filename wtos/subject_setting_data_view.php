...
<div class="content">
    ...
    <div class="item">
        <div class="uk-padding-small uk-padding-remove-bottom">
		 ...
		 <div class="uk-inline uk-hidden" uk-tooltip="Board">
                        <select name="board_s" id="board_s" class="uk-select uk-border-rounded uk-form-small "   >
    ...
    <div class="uk-modal-dialog uk-width-large uk-modal-body ">
        <div>
            ...
            <div class="uk-grid uk-grid-small uk-grid-divider uk-child-width-1-2" uk-grid>
                ...
                <div>
				  <div class="uk-inline uk-hidden" uk-tooltip="Board">
                        <select name="board" id="board" class="uk-select uk-border-rounded uk-form-small "   >
                            <option value="">Board</option>
                            <? $os->onlyOption($os->board,'');	?>
                        </select>
                    </div>
...
<script>
    ...
    function manage_subject_setting(button) // get record by table primery id
    {
		...
		var board_s=os.getVal('board_s');
        formdata.append('board_s',board_s );
