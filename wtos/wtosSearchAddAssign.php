...
saa.tab=function(saaTabLink,SaaTab,functionId)
{

os.getObj('SaaTab1'+functionId).style.display='none';
os.getObj('saaTabLink1'+functionId).className='saaTabLinkClassInActive';

os.getObj('SaaTab2'+functionId).style.display='none';
os.getObj('saaTabLink2'+functionId).className='saaTabLinkClassInActive';

os.getObj(SaaTab+functionId).style.display='';
os.getObj(saaTabLink+functionId).className='saaTabLinkClassActive';
