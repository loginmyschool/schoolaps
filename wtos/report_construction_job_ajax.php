...
$query2="select * from item_uses   where job_id='$job_id' order by dated desc  ,item_use_id desc ";
$rsResultss=$os->mq($query2);
$i=0;
while($record=$os->mfa( $rsResultss))
{
...
?>  
        ...
        <?=$os->showDate($record['dated']); ?>  : <?=$record['reff_no'] ?> 
