...
<div class="saaTabLinkClassActive " id="saaTabLink1<? echo $functionId ?>" onclick="saa.tab('saaTabLink1','SaaTab1','<? echo $functionId; ?>')" >Search</div> <div class="saaTabLinkClassInActive " onclick="saa.tab('saaTabLink2','SaaTab2','<? echo $functionId; ?>')" id="saaTabLink2<? echo $functionId ?>" >Add New Record</div>

<div class="sasclear"> </div>
<div class="SaaTabClass" id="SaaTab1<? echo $functionId ?>">
...
<div class="SaaTabClass" id="SaaTab2<? echo $functionId ?>" style="display:none;">
