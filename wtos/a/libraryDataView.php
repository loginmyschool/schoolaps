...
<tr >
										...
										<td> <select name="branch_code" id="branch_code" class="textbox fWidth" ><option value="">Select Branch</option>		  	<? 
	  									...
	  									<td>Admin </td>
										<td> <select name="admin_id" id="admin_id" class="textbox fWidth" ><option value="">Select Admin</option>		  	<? 
 ...
 library_id: <input type="text" class="wtTextClass" name="library_id_s" id="library_id_s" value="" /> &nbsp;  Name: <input type="text" class="wtTextClass" name="name_s" id="name_s" value="" /> &nbsp;  Branch:
   ...
   Admin:
	...
	<select name="admin_id" id="admin_id_s" class="textbox fWidth" ><option value="">Select Admin</option>		  	<? 
