...
?>
 ...
 <table class="container">
  ...
  <tr>
	...
	<? if($os->access('wtDelete')){ ?><input type="button" value="Delete" onclick="WT_electric_billDeleteRowById('');" /><? } ?>	 
	&nbsp;&nbsp;
	&nbsp; <input type="button" value="New" onclick="javascript:window.location='';" />
	 
	&nbsp;<? if($os->access('wtEdit')){ ?> <input type="button" value="Save" onclick="WT_electric_billEditAndSave();" /><? } ?>	 
...
<tr >
										...
										<td><input value="" type="text" name="period_to" id="period_to" class="wtDateClass textbox fWidth"/></td>						
	  									...
	  									<td>Previous unit </td>
										<td><input value="" type="text" name="previous_unit" id="previous_unit" class="textboxxx  fWidth "/> </td>						
										</tr><tr >
	  									<td>Present unit </td>
										<td><input value="" type="text" name="present_unit" id="present_unit" class="textboxxx  fWidth "/> </td>						
										</tr><tr >
	  									<td>Consume Unit </td>
	...
	<select name="payment_mode" id="payment_mode" class="textbox fWidth" ><option value="">Select Payment Mode</option>	<? 
...
formdata.append('note_s',note_sVal );
	...
	url='<? echo $ajaxFilePath ?>?WT_electric_billListing=OK&'+url;
