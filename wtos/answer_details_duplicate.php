...
<?
$pluginName='';
$listHeader='Student Answer Report';
$ajaxFilePath= 'answer_details_duplicate_ajax.php';
		...
		<tr>			 
			<td  class="middle" style="padding-left:5px;">
				...
				<table width="100%"  cellspacing="0" cellpadding="1" class="ajaxViewMainTable">
					<tr>
					  <td>
					        <input type="button" value=" DELETE DUPLICATES " onclick="delete_duplicates();" style="cursor:pointer; background-color:#FF9B9B;"/>
							Session:
							...
							Class:
							<select name="class_s" id="class_s" class="textbox fWidth" onchange="wt_ajax_chain('html*examId*exam,examId,examTitle*class=class_s','','','');">
								<option value=""> </option>	
							...
							Exam:
							<select name="examId" id="examId" class="textbox fWidth" onchange="wt_ajax_chain('html*subject_s*examdetails,subjectId,subjectId*examId=examId','','','');"  >
							</select>
...
function resultDetailsListing(act) // list table searched data get 
{
...
{
  var p =confirm('Confirm Delete duplicates?');
  
if(p){
resultDetailsListing('delete_duplicates');
}
}
</script>
