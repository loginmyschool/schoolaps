...
<tr >
										...
										<td><input value="" type="text" name="item_name" id="item_name" class="textboxxx  fWidth " style="width:200px;"/> </td>						
										</tr><tr style="display:none;" >
	  									<td>Name(Beng) </td>
										<td><input value="" type="text" name="beng_name" id="beng_name" class="textboxxx  fWidth " style="width:200px;"/> </td>						
										</tr><tr  style="display:none;" >
	  									<td>Name(Hindi) </td>
										<td><input value="" type="text" name="hindi_name" id="hindi_name" class="textboxxx  fWidth " style="width:200px;"/> </td>						
										</tr><tr >
	...
	<select name="category_id" id="category_id" class="textbox fWidth" onchange="validate_item_meta('','','')" >
	<option value=""> </option>	 
	 	...
	 	?>
										...
										<tr>
										<td colspan="2">  <div id="item_meta_container_div">&nbsp;   </div> </td>
										</tr>
										<tr >
	  									<td>Type </td>
										<td>  
...
function  validate_item_meta(category_id,item_id,save_meta)
{
...
function validate_item_meta_results(data){
