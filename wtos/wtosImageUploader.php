...
?>
<div class="imgBox">
<img src="<?php  echo $site['url'].$record['image']; ?>" alt="<?php  echo $record['title']; ?>" height="100" width="150"  onclick="javascript:insertWtImg(this);" /> <br />
	  <a href="?delete=ok&delid=<? echo $record['imageId']; ?> " title="Delete Image" style="color:#FF0000;">D</a> &nbsp;
...
<? } ?>
    ...
    {
        window.opener.tmce_rest.callback(imo.src,{text: imo.alt});
        window.close();
